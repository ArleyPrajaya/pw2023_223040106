    ...
    <div class="col-md-8">
      <form action="" method="post">
        <div class="mb-3 w-25">
          ...
          <input type="text" class="form-control" name="nim" id="nim" require maxlength="9" autofocus required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="jurusan" id="jurusan" require>
        </div>
        <div class="mb-3">
